            ...
            mount({
              ...
              '/device': compose(
                ...
                mount({
                  ...
                  '/add-metrics': route({
                    title: 'Add Metrics - Device - Monitoring',
                    getView: () =>
                      import('./containers/monitoring/add-device-metrics'),
                  }),
                  '/edit-metrics': route({
                    title: 'Edit Metrics - Device - Monitoring',
                    getView: () =>
                      import('./containers/monitoring/add-device-metrics'),
                  }),
                })
              ...
              '/service': compose(
                ...
                mount({
                  ...
                  '/add-metrics': route({
                    title: 'Add Metrics - Service - Monitoring',
                    getView: () =>
                      import('./containers/monitoring/add-service-metrics'),
                  }),
                  '/edit-metrics': route({
                    title: 'Edit Metrics - Service - Monitoring',
                    getView: () =>
                      import('./containers/monitoring/add-service-metrics'),
                  }),
                })
